...
import 'package:firebase_project/utils/debouncer.dart';
import 'package:firebase_project/utils/utilities.dart';
import 'package:firebase_project/widgets/loading_view.dart';
import 'package:flutter/material.dart';
import 'package:firebase_project/constants/app_constants.dart';
import 'package:firebase_project/constants/color_constants.dart';
import 'package:firebase_project/constants/constants.dart';
import 'package:firebase_project/providers/providers.dart';
...
class ChatsPage extends StatefulWidget {
  ...
  @override
  State createState() => ChatsPageState();
}

class ChatsPageState extends State<ChatsPage> {
  ChatsPageState({Key? key});
  ...
  late String currentUserId = currentUser!.id;
  ...
  /*List<PopupChoices> choices = <PopupChoices>[
    ...
    void initState() {
      super.initState();
      homeProvider = HomeProvider(firebaseFirestore: FirebaseFirestore.instance);
          ...
          StreamBuilder<bool>(
              ...
              builder: (context, snapshot) {
                return snapshot.data == true
                    ...
                    child: Icon(Icons.clear_rounded, color: ColorConstants.primaryColor, size: 20))
                    : SizedBox.shrink();
              }),
        ],
      ),
